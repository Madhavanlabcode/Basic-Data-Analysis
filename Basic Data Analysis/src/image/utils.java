...
public class utils{
    ...
    //The first entry is the width, the second is the height of the bitmap.
    public static int[] readHeaderOnly(FileInputStream fs)
    {
        try
            {
                 int bflen=14; // 14 byte BITMAPFILEHEADER
    ...
    public static int[] getSizeInfo(byte[][] header)
    {
    	byte[] bf = header[0];
    	byte[] bi = header[1];
        // Interperet data.
...
//        System.out.println("Colors important are :"+nclrimp);
    ...
    //24-bit bitmap, 1 plane
    public static void writeNewHeader(FileOutputStream writer, int width, int height)
    {
    	try {
	    	writer.write (new byte[] {(byte)'B', (byte)'M'});
	    	writer.write (intToDWord (width*height*3 + 54));
			writer.write (intToWord (0));
			writer.write (intToWord (0));
	    	writer.write (intToDWord (54));

	    	writer.write (intToDWord (40));
	    	writer.write (intToDWord (width));
	    	writer.write (intToDWord (height));
	    	writer.write (intToWord (1));
	    	writer.write (intToWord (24));
	    	writer.write (intToDWord (0));
	    	writer.write (intToDWord (width*height*3));
	    	writer.write (intToDWord (1));
	    	writer.write (intToDWord (1));
	    	writer.write (intToDWord (0));
	    	writer.write (intToDWord (0));
    ...
    public static void writeNewHeader32(FileOutputStream writer, int width, int height)
    {
    	try {
	    	writer.write (new byte[] {(byte)'B', (byte)'M'});
	    	writer.write (intToDWord (width*height*4 + 54));
			writer.write (intToWord (0));
			writer.write (intToWord (0));
	    	writer.write (intToDWord (54));
	    	...
	    	writer.write (intToDWord (height));
	    	writer.write (intToWord (1));
	    	writer.write (intToWord (32));
	    	writer.write (intToDWord (0));
	    	writer.write (intToDWord (width*height*4));
	    	writer.write (intToDWord (1));
	    	writer.write (intToDWord (1));
	    	writer.write (intToDWord (0));
	    	writer.write (intToDWord (0));
    ...
    public static void writeHeader(FileOutputStream writer, byte[][] header)
    {
    	try {
    ...
    //The first entry is the width, the second is the height of the bitmap.
    public static byte[][] getHeader(FileInputStream fs)
    {
        try
            {
                 int bflen=14; // 14 byte BITMAPFILEHEADER
    ...
    public static byte[] readSomeBytes(byte[] buffer, FileInputStream file)
    {
        try {
